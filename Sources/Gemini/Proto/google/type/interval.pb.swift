...
struct Google_Type_Interval: Sendable {
...
extension Google_Type_Interval: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}start_time\0\u{3}end_time\0")
  ...
  static func ==(lhs: Google_Type_Interval, rhs: Google_Type_Interval) -> Bool {
