...
public struct ModelResponse: Codable, Sendable {
    ...
    /// The provider name that generated the response.
...
public extension ModelStreamResponse {
    /// A container for a streaming event, including the event name and its associated data.
    struct Event<T>: Codable, Sendable where T: Codable & Sendable {
...
public extension ModelStreamResponse {
    ...
    struct EventName: RawRepresentable, Hashable, Codable, Sendable {
...
public extension ModelStreamResponse.EventName {
