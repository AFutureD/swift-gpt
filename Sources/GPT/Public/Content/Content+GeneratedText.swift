...
extension ContentType {
    ...
    public static let generatedText = ContentType(rawValue: "response.message.text")
}
...
extension ContentType {
    public static let textAnnotation = ContentType(rawValue: "response.message.text.annotation")
}
...
extension ContentType {
    ...
    public static let generatedTextRefusal = ContentType(rawValue: "response.message.text.refusal")
}
